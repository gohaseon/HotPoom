...
<form id="hotelInsert" action="" method="post">
        ...
        <h1>품</h1><br>
            ...
            <h2>품 소개하기</h2><br>
                ...
                <div id="photoSection">
                    ...
                    </div> <div id="mainPhotoMsg" class="msg">대표사진을 입력해 주세요</div><br><br>
                ...
                <button id="poomEditBtn" class="edit_btn" type="button" data-idx="0">사진추가</button>
                </div>
    ...
    <div class="page" id="seconPage">
       ...
       <input id="animalInput" type="text" value="">
        <br><div id="animalMsg" class="msg">종류를 선택해 주세요</div><h1 id="animalName"></h1>
            <div id="animalList">
            <ul id="animals">
        ...
        <button id="facilityEditBtn" class="edit_btn" type="button" data-idx="1">사진추가</button>
        </div>
    ...
    <div class="page"  id="thirdPage">
        ...
        <input type="button" id="searchBtn" value="우편번호 찾기"><br><br>
        ...
        <p>
            <input type="text" id="subAddress" placeholder="상세주소" size="50" name="subAddress"><br><br><br><br>
        </p>
        ...
        <button id="trafficEditBtn" class="edit_btn" type="button" data-idx="2">사진추가</button>
        </div>
...
poomEdit.eventManager.addEventType('Event1');

poomEdit.eventManager.listen('Event1', function() {
    //alert("test");
    $upload.click();
...
$("#subPhotoInput").change(function () {
    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            $("<img src="+json.url+" class='sub_photo'>").prependTo("#subPhotoWrap");
